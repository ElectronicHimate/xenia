...
// --- NEON Math Stubs (Plan B Fallbacks) ---
void ff_vector_fmul_scalar_neon(void) {}
void ff_scalarproduct_float_neon(void) {}
void ff_butterflies_float_neon(void) {}
void ff_vector_fmul_add_neon(void) {}
void ff_vector_fmul_window_neon(void) {}
void ff_vector_dmul_scalar_neon(void) {}
void ff_vector_fmac_scalar_neon(void) {}
void ff_vector_fmul_reverse_neon(void) {}
void ff_vector_fmul_neon(void) {}
void ff_mpadsp_apply_window_float_neon(void) {}
void ff_mpadsp_apply_window_fixed_neon(void) {}
